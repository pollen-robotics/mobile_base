...
input(
    "Press Enter to request several gotos, start moving and 1 second later, cancel_all_goto. The robot should stop and cancell all goals"
)
...
input(
    "Press Enter to request a goto, start moving and 1 second later, cancel by id. The robot should stop and cancell all goals"
)
id1 = reachy.mobile_base.goto(
    x=1.0, y=0.0, theta=00.0, wait=False, degrees=True, distance_tolerance=0.05, angle_tolerance=5.0, timeout=10000
)
time.sleep(1.0)
