...
* [zuuu_description](../zuuu_description): if you want to use visualization or simulation tools (e.g. rviz, gazebo)
For the installation of this package, refer to the [dedicated README](../zuuu_description/README.md).
