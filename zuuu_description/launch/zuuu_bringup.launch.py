...
def generate_launch_description():
    ...
    default_rviz_config_path = os.path.join(pkg_share, "rviz/bringup.rviz")
    ...
    launches = [
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(pkg_share, "launch", "description_bringup.launch.py")),
        ),
        IncludeLaunchDescription(
