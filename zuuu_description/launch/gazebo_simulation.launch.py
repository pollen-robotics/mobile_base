...
def generate_launch_description():
    ...
    robot_state_publisher_node = Node(
        package="robot_state_publisher", executable="robot_state_publisher", parameters=[robot_description, use_sim_time_param]
    )
    ...
    spawn_entity = Node(
        ...
        arguments=["-entity", "zuuu", "-topic", "robot_description", "-timeout", "60", "-x", "0", "-y", "2"],
        output="screen",
    )
    ...
    robot_localization_node = Node(
        ...
        output="screen",
        parameters=[os.path.join(pkg_share, "config/ekf.yaml"), use_sim_time_param],
    )
